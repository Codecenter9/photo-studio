    ...
    >
      {!settings?.allowUserRegistration ? (
        <div className="flex flex-col items-center gap-3">
          <span className="text-lg font-serif">Registration is not allowed for now</span>
          <Link href="/auth/login" className="px-3 rounded-md text-blue-500 hover:bg-blue-300 hover:text-gray-50 transition-all duration-300">Back to login</Link>
        </div>
      ) : (
